...
description: "A simple guide to send logs from Docker to GCP Cloud Storage (GCS) in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Docker to GCP Cloud Storage (GCS) Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","source: docker","sink: gcp_cloud_storage"]
...
<!--
     ...
     website/guides/integrate/platforms/docker/gcp_cloud_storage.md.erb
-->
