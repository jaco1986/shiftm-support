...
description: "A simple guide to send logs from Docker to Datadog in just a few minutes."
...
Fear not! In this guide we'll show you how to send send logs from [Docker][urls.docker] to [Datadog][urls.datadog]
...
<!--
     ...
     website/guides/integrate/platforms/docker/datadog_logs.md.erb
-->
