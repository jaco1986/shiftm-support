...
description: "A simple guide to send logs from Docker to AWS Kinesis Data Streams in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Docker to AWS Kinesis Data Streams Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","source: docker","sink: aws_kinesis_streams"]
...
Fear not! In this guide we'll show you how to send send logs from [Docker][urls.docker] to [AWS Kinesis Data Streams][urls.aws_kinesis_streams]
...
<!--
     ...
     website/guides/integrate/platforms/docker/aws_kinesis_streams.md.erb
-->
