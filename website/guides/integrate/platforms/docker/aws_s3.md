...
description: "A simple guide to send logs from Docker to AWS S3 in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Docker to AWS S3 Integration"
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","source: docker","sink: aws_s3"]
...
Fear not! In this guide we'll show you how to send send logs from [Docker][urls.docker] to [AWS S3][urls.aws_s3]
...
<!--
     ...
     website/guides/integrate/platforms/docker/aws_s3.md.erb
-->
