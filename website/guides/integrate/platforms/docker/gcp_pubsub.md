...
tags: ["type: tutorial","domain: platforms","domain: sinks","platform: docker","source: docker","sink: gcp_pubsub"]
...
Fear not! In this guide we'll show you how to send send logs from [Docker][urls.docker] to [GCP PubSub][urls.gcp_pubsub]
...
<!--
     ...
     website/guides/integrate/platforms/docker/gcp_pubsub.md.erb
-->
