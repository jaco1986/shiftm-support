...
description: "A simple guide to send logs from a file to GCP PubSub in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "File to GCP PubSub Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: file","sink: gcp_pubsub"]
...
Fear not! In this guide we'll show you how to send send logs from [a file][urls.file] to [GCP PubSub][urls.gcp_pubsub]
...
<!--
     ...
     website/guides/integrate/sources/file/gcp_pubsub.md.erb
-->
