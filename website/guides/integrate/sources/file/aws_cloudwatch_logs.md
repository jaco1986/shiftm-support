...
description: "A simple guide to send logs from a file to AWS Cloudwatch in just a few minutes."
...
Fear not! In this guide we'll show you how to send send logs from [a file][urls.file] to [AWS Cloudwatch][urls.aws_cloudwatch]
