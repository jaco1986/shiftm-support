...
description: "A simple guide to send logs from a file to Elasticsearch in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "File to Elasticsearch Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: file","sink: elasticsearch"]
...
Fear not! In this guide we'll show you how to send send logs from [a file][urls.file] to [Elasticsearch][urls.elasticsearch]
...
<!--
     ...
     website/guides/integrate/sources/file/elasticsearch.md.erb
-->
