...
description: "A simple guide to send logs from a file to GCP Cloud Storage (GCS) in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "File to GCP Cloud Storage (GCS) Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: file","sink: gcp_cloud_storage"]
...
Fear not! In this guide we'll show you how to send send logs from [a file][urls.file] to [GCP Cloud Storage (GCS)][urls.gcp_cloud_storage]
...
<!--
     ...
     website/guides/integrate/sources/file/gcp_cloud_storage.md.erb
-->
