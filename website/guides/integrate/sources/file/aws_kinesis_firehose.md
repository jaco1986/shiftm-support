...
description: "A simple guide to send logs from a file to AWS Kinesis Firehose in just a few minutes."
...
Fear not! In this guide we'll show you how to send send logs from [a file][urls.file] to [AWS Kinesis Firehose][urls.aws_kinesis_firehose]
