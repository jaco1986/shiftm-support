...
description: "A simple guide to send logs from a file to AWS S3 in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "File to AWS S3 Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: file","sink: aws_s3"]
...
Fear not! In this guide we'll show you how to send send logs from [a file][urls.file] to [AWS S3][urls.aws_s3]
...
<!--
     ...
     website/guides/integrate/sources/file/aws_s3.md.erb
-->
