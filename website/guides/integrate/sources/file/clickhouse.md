...
cover_label: "File to Clickhouse Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: file","sink: clickhouse"]
...
Fear not! In this guide we'll show you how to send send logs from [a file][urls.file] to [Clickhouse][urls.clickhouse]
