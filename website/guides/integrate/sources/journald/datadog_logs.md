...
description: "A simple guide to send logs from Journald to Datadog in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Journald to Datadog Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: journald","sink: datadog_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [Journald][urls.journald] to [Datadog][urls.datadog]
...
<!--
     ...
     website/guides/integrate/sources/journald/datadog_logs.md.erb
-->
