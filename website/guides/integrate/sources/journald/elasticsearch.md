...
description: "A simple guide to send logs from Journald to Elasticsearch in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Journald to Elasticsearch Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: journald","sink: elasticsearch"]
...
Fear not! In this guide we'll show you how to send send logs from [Journald][urls.journald] to [Elasticsearch][urls.elasticsearch]
...
<!--
     ...
     website/guides/integrate/sources/journald/elasticsearch.md.erb
-->
