...
description: "A simple guide to send logs from Journald to GCP PubSub in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Journald to GCP PubSub Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: journald","sink: gcp_pubsub"]
...
Fear not! In this guide we'll show you how to send send logs from [Journald][urls.journald] to [GCP PubSub][urls.gcp_pubsub]
...
<!--
     ...
     website/guides/integrate/sources/journald/gcp_pubsub.md.erb
-->
