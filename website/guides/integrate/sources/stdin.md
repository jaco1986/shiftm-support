...
cover_label: "STDIN Integration"
tags: ["type: tutorial","domain: sources","source: stdin"]
...
Fear not! In this guide we'll show you how to send collect logs from [STDIN][urls.stdin] and send them anywhere
...
<!--
     ...
     website/guides/integrate/sources/stdin.md.erb
-->
