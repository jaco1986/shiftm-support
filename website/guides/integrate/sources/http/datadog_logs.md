...
description: "A simple guide to send logs from HTTP to Datadog in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "HTTP to Datadog Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: http","sink: datadog_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [HTTP][urls.http] to [Datadog][urls.datadog]
...
<!--
     ...
     website/guides/integrate/sources/http/datadog_logs.md.erb
-->
