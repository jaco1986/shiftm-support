...
description: "A simple guide to send logs from HTTP to AWS Kinesis Firehose in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "HTTP to AWS Kinesis Firehose Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: http","sink: aws_kinesis_firehose"]
...
Fear not! In this guide we'll show you how to send send logs from [HTTP][urls.http] to [AWS Kinesis Firehose][urls.aws_kinesis_firehose]
...
<!--
     ...
     website/guides/integrate/sources/http/aws_kinesis_firehose.md.erb
-->
