...
description: "A simple guide to send logs from HTTP to AWS Kinesis Data Streams in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "HTTP to AWS Kinesis Data Streams Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: http","sink: aws_kinesis_streams"]
...
Fear not! In this guide we'll show you how to send send logs from [HTTP][urls.http] to [AWS Kinesis Data Streams][urls.aws_kinesis_streams]
...
<!--
     ...
     website/guides/integrate/sources/http/aws_kinesis_streams.md.erb
-->
