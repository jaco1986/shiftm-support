...
description: "A simple guide to send logs from HTTP to GCP Cloud Storage (GCS) in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "HTTP to GCP Cloud Storage (GCS) Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: http","sink: gcp_cloud_storage"]
...
Fear not! In this guide we'll show you how to send send logs from [HTTP][urls.http] to [GCP Cloud Storage (GCS)][urls.gcp_cloud_storage]
...
<!--
     ...
     website/guides/integrate/sources/http/gcp_cloud_storage.md.erb
-->
