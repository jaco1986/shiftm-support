...
description: "A simple guide to send logs from HTTP to AWS Cloudwatch in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "HTTP to AWS Cloudwatch Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: http","sink: aws_cloudwatch_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [HTTP][urls.http] to [AWS Cloudwatch][urls.aws_cloudwatch]
...
<!--
     ...
     website/guides/integrate/sources/http/aws_cloudwatch_logs.md.erb
-->
