...
description: "A simple guide to send logs from HTTP to Clickhouse in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "HTTP to Clickhouse Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: http","sink: clickhouse"]
...
Fear not! In this guide we'll show you how to send send logs from [HTTP][urls.http] to [Clickhouse][urls.clickhouse]
...
<!--
     ...
     website/guides/integrate/sources/http/clickhouse.md.erb
-->
