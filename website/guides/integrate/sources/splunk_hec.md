...
description: "A simple guide to collect logs from Splunk HEC and send them anywhere in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Splunk HEC Integration"
tags: ["type: tutorial","domain: sources","source: splunk_hec"]
...
Fear not! In this guide we'll show you how to send collect logs from [Splunk HEC][urls.splunk_hec] and send them anywhere
...
<!--
     ...
     website/guides/integrate/sources/splunk_hec.md.erb
-->
