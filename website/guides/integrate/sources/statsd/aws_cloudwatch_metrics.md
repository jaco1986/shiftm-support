...
cover_label: "Statsd to AWS Cloudwatch Metrics Integration"
...
Fear not! In this guide we'll show you how to send send metrics from [Statsd][urls.statsd] to [AWS Cloudwatch][urls.aws_cloudwatch]
