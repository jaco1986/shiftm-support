...
description: "A simple guide to send logs from a TCP, UDP, or UDS socket to GCP Cloud Storage (GCS) in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Socket to GCP Cloud Storage (GCS) Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: socket","sink: gcp_cloud_storage"]
...
Fear not! In this guide we'll show you how to send send logs from [a TCP, UDP, or UDS socket][urls.socket] to [GCP Cloud Storage (GCS)][urls.gcp_cloud_storage]
...
<!--
     ...
     website/guides/integrate/sources/socket/gcp_cloud_storage.md.erb
-->
