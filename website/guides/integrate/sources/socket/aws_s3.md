...
cover_label: "Socket to AWS S3 Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: socket","sink: aws_s3"]
...
Fear not! In this guide we'll show you how to send send logs from [a TCP, UDP, or UDS socket][urls.socket] to [AWS S3][urls.aws_s3]
...
<!--
     ...
     website/guides/integrate/sources/socket/aws_s3.md.erb
-->
