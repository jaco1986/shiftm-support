...
description: "A simple guide to send logs from a TCP, UDP, or UDS socket to Datadog in just a few minutes."
...
Fear not! In this guide we'll show you how to send send logs from [a TCP, UDP, or UDS socket][urls.socket] to [Datadog][urls.datadog]
...
<!--
     ...
     website/guides/integrate/sources/socket/datadog_logs.md.erb
-->
