...
cover_label: "Socket to AWS Kinesis Firehose Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: socket","sink: aws_kinesis_firehose"]
...
Fear not! In this guide we'll show you how to send send logs from [a TCP, UDP, or UDS socket][urls.socket] to [AWS Kinesis Firehose][urls.aws_kinesis_firehose]
...
<!--
     ...
     website/guides/integrate/sources/socket/aws_kinesis_firehose.md.erb
-->
