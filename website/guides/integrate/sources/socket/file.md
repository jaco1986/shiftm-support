...
cover_label: "Socket to File Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: socket","sink: file"]
...
Fear not! In this guide we'll show you how to send send logs from [a TCP, UDP, or UDS socket][urls.socket] to [a file][urls.file]
...
<!--
     ...
     website/guides/integrate/sources/socket/file.md.erb
-->
