...
description: "A simple guide to send logs from a TCP, UDP, or UDS socket to GCP PubSub in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Socket to GCP PubSub Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: socket","sink: gcp_pubsub"]
...
Fear not! In this guide we'll show you how to send send logs from [a TCP, UDP, or UDS socket][urls.socket] to [GCP PubSub][urls.gcp_pubsub]
...
<!--
     ...
     website/guides/integrate/sources/socket/gcp_pubsub.md.erb
-->
