...
description: "A simple guide to send logs from a TCP, UDP, or UDS socket to Elasticsearch in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Socket to Elasticsearch Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: socket","sink: elasticsearch"]
...
Fear not! In this guide we'll show you how to send send logs from [a TCP, UDP, or UDS socket][urls.socket] to [Elasticsearch][urls.elasticsearch]
...
<!--
     ...
     website/guides/integrate/sources/socket/elasticsearch.md.erb
-->
