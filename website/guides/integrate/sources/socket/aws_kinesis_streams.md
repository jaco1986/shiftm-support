...
description: "A simple guide to send logs from a TCP, UDP, or UDS socket to AWS Kinesis Data Streams in just a few minutes."
...
Fear not! In this guide we'll show you how to send send logs from [a TCP, UDP, or UDS socket][urls.socket] to [AWS Kinesis Data Streams][urls.aws_kinesis_streams]
