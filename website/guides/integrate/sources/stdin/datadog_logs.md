...
description: "A simple guide to send logs from STDIN to Datadog in just a few minutes."
...
Fear not! In this guide we'll show you how to send send logs from [STDIN][urls.stdin] to [Datadog][urls.datadog]
...
<!--
     ...
     website/guides/integrate/sources/stdin/datadog_logs.md.erb
-->
