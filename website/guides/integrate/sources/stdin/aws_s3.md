...
description: "A simple guide to send logs from STDIN to AWS S3 in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "STDIN to AWS S3 Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: stdin","sink: aws_s3"]
...
Fear not! In this guide we'll show you how to send send logs from [STDIN][urls.stdin] to [AWS S3][urls.aws_s3]
...
<!--
     ...
     website/guides/integrate/sources/stdin/aws_s3.md.erb
-->
