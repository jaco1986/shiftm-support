...
description: "A simple guide to send logs from STDIN to a file in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "STDIN to File Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: stdin","sink: file"]
...
Fear not! In this guide we'll show you how to send send logs from [STDIN][urls.stdin] to [a file][urls.file]
...
<!--
     ...
     website/guides/integrate/sources/stdin/file.md.erb
-->
