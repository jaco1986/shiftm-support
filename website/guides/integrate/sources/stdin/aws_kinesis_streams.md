...
description: "A simple guide to send logs from STDIN to AWS Kinesis Data Streams in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "STDIN to AWS Kinesis Data Streams Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: stdin","sink: aws_kinesis_streams"]
