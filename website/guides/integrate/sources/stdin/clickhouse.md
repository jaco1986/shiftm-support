...
cover_label: "STDIN to Clickhouse Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: stdin","sink: clickhouse"]
...
Fear not! In this guide we'll show you how to send send logs from [STDIN][urls.stdin] to [Clickhouse][urls.clickhouse]
...
<!--
     ...
     website/guides/integrate/sources/stdin/clickhouse.md.erb
-->
