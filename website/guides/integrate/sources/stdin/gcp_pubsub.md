...
description: "A simple guide to send logs from STDIN to GCP PubSub in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "STDIN to GCP PubSub Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: stdin","sink: gcp_pubsub"]
...
Fear not! In this guide we'll show you how to send send logs from [STDIN][urls.stdin] to [GCP PubSub][urls.gcp_pubsub]
...
<!--
     ...
     website/guides/integrate/sources/stdin/gcp_pubsub.md.erb
-->
