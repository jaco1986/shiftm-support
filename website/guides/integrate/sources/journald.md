...
cover_label: "Journald Integration"
...
Fear not! In this guide we'll show you how to send collect logs from [Journald][urls.journald] and send them anywhere
...
<!--
     ...
     website/guides/integrate/sources/journald.md.erb
-->
