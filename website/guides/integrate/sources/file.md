...
description: "A simple guide to collect logs from a file and send them anywhere in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "File Integration"
tags: ["type: tutorial","domain: sources","source: file"]
...
Fear not! In this guide we'll show you how to send collect logs from [a file][urls.file] and send them anywhere
...
<!--
     ...
     website/guides/integrate/sources/file.md.erb
-->
