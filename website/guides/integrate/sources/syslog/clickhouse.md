...
Fear not! In this guide we'll show you how to send send logs from [Syslog][urls.syslog] to [Clickhouse][urls.clickhouse]
...
<!--
     ...
     website/guides/integrate/sources/syslog/clickhouse.md.erb
-->
