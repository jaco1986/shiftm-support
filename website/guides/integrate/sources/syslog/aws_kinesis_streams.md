...
description: "A simple guide to send logs from Syslog to AWS Kinesis Data Streams in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Syslog to AWS Kinesis Data Streams Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: syslog","sink: aws_kinesis_streams"]
...
Fear not! In this guide we'll show you how to send send logs from [Syslog][urls.syslog] to [AWS Kinesis Data Streams][urls.aws_kinesis_streams]
...
<!--
     ...
     website/guides/integrate/sources/syslog/aws_kinesis_streams.md.erb
-->
