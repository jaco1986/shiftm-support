...
description: "A simple guide to send logs from Syslog to AWS Cloudwatch in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Syslog to AWS Cloudwatch Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: syslog","sink: aws_cloudwatch_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [Syslog][urls.syslog] to [AWS Cloudwatch][urls.aws_cloudwatch]
...
<!--
     ...
     website/guides/integrate/sources/syslog/aws_cloudwatch_logs.md.erb
-->
