...
description: "A simple guide to send logs from Syslog to Elasticsearch in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Syslog to Elasticsearch Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: syslog","sink: elasticsearch"]
...
Fear not! In this guide we'll show you how to send send logs from [Syslog][urls.syslog] to [Elasticsearch][urls.elasticsearch]
...
<!--
     ...
     website/guides/integrate/sources/syslog/elasticsearch.md.erb
-->
