...
description: "A simple guide to send logs from Splunk HEC to Clickhouse in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Splunk HEC to Clickhouse Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: splunk_hec","sink: clickhouse"]
...
Fear not! In this guide we'll show you how to send send logs from [Splunk HEC][urls.splunk_hec] to [Clickhouse][urls.clickhouse]
...
<!--
     ...
     website/guides/integrate/sources/splunk_hec/clickhouse.md.erb
-->
