...
description: "A simple guide to send logs from Splunk HEC to AWS Kinesis Data Streams in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Splunk HEC to AWS Kinesis Data Streams Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: splunk_hec","sink: aws_kinesis_streams"]
...
Fear not! In this guide we'll show you how to send send logs from [Splunk HEC][urls.splunk_hec] to [AWS Kinesis Data Streams][urls.aws_kinesis_streams]
...
<!--
     ...
     website/guides/integrate/sources/splunk_hec/aws_kinesis_streams.md.erb
-->
...
<Jump to="/docs/about/what-is-shiftm/" leftIcon="book">
