...
description: "A simple guide to send logs from Splunk HEC to AWS Cloudwatch in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Splunk HEC to AWS Cloudwatch Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: splunk_hec","sink: aws_cloudwatch_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [Splunk HEC][urls.splunk_hec] to [AWS Cloudwatch][urls.aws_cloudwatch]
...
<!--
     ...
     website/guides/integrate/sources/splunk_hec/aws_cloudwatch_logs.md.erb
-->
