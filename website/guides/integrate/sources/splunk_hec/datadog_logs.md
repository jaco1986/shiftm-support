...
description: "A simple guide to send logs from Splunk HEC to Datadog in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Splunk HEC to Datadog Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: splunk_hec","sink: datadog_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [Splunk HEC][urls.splunk_hec] to [Datadog][urls.datadog]
...
<!--
     ...
     website/guides/integrate/sources/splunk_hec/datadog_logs.md.erb
-->
