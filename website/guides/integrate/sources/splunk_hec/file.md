...
description: "A simple guide to send logs from Splunk HEC to a file in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Splunk HEC to File Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: splunk_hec","sink: file"]
...
Fear not! In this guide we'll show you how to send send logs from [Splunk HEC][urls.splunk_hec] to [a file][urls.file]
...
<!--
     ...
     website/guides/integrate/sources/splunk_hec/file.md.erb
-->
