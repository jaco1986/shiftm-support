...
description: "A simple guide to send logs from Splunk HEC to AWS S3 in just a few minutes."
...
Fear not! In this guide we'll show you how to send send logs from [Splunk HEC][urls.splunk_hec] to [AWS S3][urls.aws_s3]
...
<!--
     ...
     website/guides/integrate/sources/splunk_hec/aws_s3.md.erb
-->
