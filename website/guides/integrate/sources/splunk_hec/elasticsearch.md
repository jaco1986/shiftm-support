...
cover_label: "Splunk HEC to Elasticsearch Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: splunk_hec","sink: elasticsearch"]
...
Fear not! In this guide we'll show you how to send send logs from [Splunk HEC][urls.splunk_hec] to [Elasticsearch][urls.elasticsearch]
...
<!--
     ...
     website/guides/integrate/sources/splunk_hec/elasticsearch.md.erb
-->
