...
cover_label: "Splunk HEC to GCP Cloud Storage (GCS) Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: splunk_hec","sink: gcp_cloud_storage"]
...
Fear not! In this guide we'll show you how to send send logs from [Splunk HEC][urls.splunk_hec] to [GCP Cloud Storage (GCS)][urls.gcp_cloud_storage]
...
<!--
     ...
     website/guides/integrate/sources/splunk_hec/gcp_cloud_storage.md.erb
-->
