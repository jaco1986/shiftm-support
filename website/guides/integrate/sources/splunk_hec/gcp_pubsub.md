...
description: "A simple guide to send logs from Splunk HEC to GCP PubSub in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Splunk HEC to GCP PubSub Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: splunk_hec","sink: gcp_pubsub"]
...
Fear not! In this guide we'll show you how to send send logs from [Splunk HEC][urls.splunk_hec] to [GCP PubSub][urls.gcp_pubsub]
...
<!--
     ...
     website/guides/integrate/sources/splunk_hec/gcp_pubsub.md.erb
-->
