...
description: "A simple guide to send logs from Kafka to Clickhouse in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kafka to Clickhouse Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kafka","sink: clickhouse"]
...
Fear not! In this guide we'll show you how to send send logs from [Kafka][urls.kafka] to [Clickhouse][urls.clickhouse]
...
<!--
     ...
     website/guides/integrate/sources/kafka/clickhouse.md.erb
-->
