...
description: "A simple guide to send logs from Kafka to Datadog in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kafka to Datadog Logs Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kafka","sink: datadog_logs"]
...
Fear not! In this guide we'll show you how to send send logs from [Kafka][urls.kafka] to [Datadog][urls.datadog]
...
<!--
     ...
     website/guides/integrate/sources/kafka/datadog_logs.md.erb
-->
