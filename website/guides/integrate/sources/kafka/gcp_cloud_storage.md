...
cover_label: "Kafka to GCP Cloud Storage (GCS) Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kafka","sink: gcp_cloud_storage"]
...
Fear not! In this guide we'll show you how to send send logs from [Kafka][urls.kafka] to [GCP Cloud Storage (GCS)][urls.gcp_cloud_storage]
