...
description: "A simple guide to send logs from Kafka to GCP PubSub in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kafka to GCP PubSub Integration"
...
Fear not! In this guide we'll show you how to send send logs from [Kafka][urls.kafka] to [GCP PubSub][urls.gcp_pubsub]
