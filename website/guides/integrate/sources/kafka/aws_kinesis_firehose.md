...
description: "A simple guide to send logs from Kafka to AWS Kinesis Firehose in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kafka to AWS Kinesis Firehose Integration"
...
Fear not! In this guide we'll show you how to send send logs from [Kafka][urls.kafka] to [AWS Kinesis Firehose][urls.aws_kinesis_firehose]
