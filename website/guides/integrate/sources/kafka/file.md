...
cover_label: "Kafka to File Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kafka","sink: file"]
...
Fear not! In this guide we'll show you how to send send logs from [Kafka][urls.kafka] to [a file][urls.file]
...
<!--
     ...
     website/guides/integrate/sources/kafka/file.md.erb
-->
