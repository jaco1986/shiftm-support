...
description: "A simple guide to send logs from Kafka to Elasticsearch in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Kafka to Elasticsearch Integration"
tags: ["type: tutorial","domain: sources","domain: sinks","source: kafka","sink: elasticsearch"]
