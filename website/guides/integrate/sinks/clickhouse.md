...
description: "A simple guide to send logs to Clickhouse in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Clickhouse Integration"
tags: ["type: tutorial","domain: sinks","sink: clickhouse"]
...
Fear not! In this guide we'll show you how to send send logs to [Clickhouse][urls.clickhouse]
...
<!--
     ...
     website/guides/integrate/sinks/clickhouse.md.erb
-->
