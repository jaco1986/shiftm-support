...
description: "A simple guide to send metrics to Datadog in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "Datadog Metrics Integration"
tags: ["type: tutorial","domain: sinks","sink: datadog_metrics"]
...
Fear not! In this guide we'll show you how to send send metrics to [Datadog][urls.datadog]
...
<!--
     ...
     website/guides/integrate/sinks/datadog_metrics.md.erb
-->
