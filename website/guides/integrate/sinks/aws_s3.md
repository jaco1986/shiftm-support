...
cover_label: "AWS S3 Integration"
tags: ["type: tutorial","domain: sinks","sink: aws_s3"]
...
Fear not! In this guide we'll show you how to send send logs to [AWS S3][urls.aws_s3]
