...
cover_label: "Elasticsearch Integration"
tags: ["type: tutorial","domain: sinks","sink: elasticsearch"]
...
Fear not! In this guide we'll show you how to send send logs to [Elasticsearch][urls.elasticsearch]
