...
description: "A simple guide to send logs to AWS Cloudwatch in just a few minutes."
author_github: https://github.com/binarylogic
cover_label: "AWS Cloudwatch Logs Integration"
tags: ["type: tutorial","domain: sinks","sink: aws_cloudwatch_logs"]
...
Fear not! In this guide we'll show you how to send send logs to [AWS Cloudwatch][urls.aws_cloudwatch]
...
<!--
     ...
     website/guides/integrate/sinks/aws_cloudwatch_logs.md.erb
-->
