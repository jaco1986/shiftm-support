...
tags: ["type: tutorial","domain: sinks","sink: file"]
...
Fear not! In this guide we'll show you how to send send logs to [a file][urls.file]
...
<!--
     ...
     website/guides/integrate/sinks/file.md.erb
-->
